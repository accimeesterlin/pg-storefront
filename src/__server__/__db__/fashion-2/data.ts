...
export const products = [
  ...
  },
  {
    ...
    colors: [],
    comparePrice: 0,
    mainImageUrl: "/assets/images/products/Fashion/Shoes/1.Nike Red.png",
    images: [
      { url: "/assets/images/products/Fashion/Shoes/1.Nike Red.png" },
      { url: "/assets/images/products/Fashion/Shoes/1.Nike Red.png" },
    ],
    categories: ["Men's Fashion"],
    status: null,
  ...
  //   best week products
  {
    ...
    colors: [],
    comparePrice: 0,
    mainImageUrl: "/assets/images/products/Fashion/Jewellery/2.Black Metal Ring.png",
    images: [
      { url: "/assets/images/products/Fashion/Jewellery/2.Black Metal Ring.png" },
      { url: "/assets/images/products/Fashion/Jewellery/2.Black Metal Ring.png" },
    ],
    categories: ["Women's Fashion"],
    status: null,
...
export const articles = [
  ...
  },
  {
    ...
    name: "10% Discount for Cosmatics",
    description: "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Phasellus hendrerit.…",
    mainImageUrl: "/assets/images/blogs/blog-2.jpg",
    shop: {
  ...
  },
  {
    ...
    name: " Buy 2 get 1 free Offer",
    description: "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Phasellus hendrerit.…",
    mainImageUrl: "/assets/images/blogs/blog-3.jpg",
    shop: {
      id: "e7c5030b-0504-4b4c-81dc-1627302bc1a4",
      slug: "scarlett-beauty",
      user: {
